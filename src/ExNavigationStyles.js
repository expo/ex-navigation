...
function customForVerticalDown(props: NavigationSceneRendererProps): Object {
  const { layout, position, scene } = props;
...
export const SlideVerticalDown: ExNavigationStyles = {
  configureTransition: configureSpringTransition,
  sceneAnimations: customForVerticalDown,
  navigationBarAnimations: {
    forContainer: (props, delta) => {
      const { layout, position, scene, scenes } = props;
